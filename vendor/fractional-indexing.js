// Vendored from fractional-indexing@4.0.0 (https://github.com/rocicorp/fractional-indexing)
// License: CC0 (no rights reserved).
//
// Reason for vendoring: the upstream package is ESM-only ("type": "module") with
// no CommonJS entry point, so `require('fractional-indexing')` throws
// ERR_REQUIRE_ESM in Electron's CommonJS main process. This file is the
// upstream src/index.js with `export` rewritten to `module.exports`.
//
// DO NOT hand-edit beyond the export footer — re-vendor from upstream when
// upgrading.
...
const BASE_52_DIGITS = BASE_62_DIGITS.slice(10); // A-Z + a-z
...
function incrementInteger(x, digits, lookup, intDigits, intLookup) {
  ...
  // the head moves one step toward the largest digit; grow or shrink the
