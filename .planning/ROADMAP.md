...
**Requirements**: TBD
**Depends on:** Phase 43
**Plans:** 16 plans（13 executed + 3 gap-closure planned, 44-UAT.md gaps G-44-2/G-44-4/G-44-6）
...
- [ ] 44-14-PLAN.md — G-44-2 规避：播放器窗口关闭/ tab guest 销毁序列延迟 + dev 销毁诊断日志
- [ ] 44-16-PLAN.md — G-44-4 录制时长本地时钟平滑推进（含新单测）+ G-44-6 抽屉「时钟图标+时间」并排常显

**Gap Closure Wave 2** *(blocked on 44-14)*

- [ ] 44-15-PLAN.md — G-44-2 Electron 43 补丁线升级（43.3.0→43.4.11）+ UA/CH 全版本号常量同步 + 打包验证
