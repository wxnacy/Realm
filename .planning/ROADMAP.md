...
**Requirements**: TBD
**Depends on:** Phase 43
**Plans:** 8 plans（5 executed + 3 gap-closure pending, 44-VERIFICATION.md gaps_found）
...
- [ ] 44-06-PLAN.md — CR-01/CR-05 gap 闭合：缓存命中先于回源（key=target）+ 源流 error 防护 + WR-06 hlsRetryCount 复位（D-03/D-05/D-10）
- [ ] 44-07-PLAN.md — CR-02/CR-03 gap 闭合：storeBuffer 写路径容量水位淘汰 + setCapacityBytes + RECORD_ROOT 补算（D-06/D-07/D-08/D-18）
