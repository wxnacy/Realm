...
| 42. AI 历史对话管理功能 | v2.5 | 3/5 | In Progress|  |
...
**Depends on:** Phase 41
**Plans:** 3/5 plans executed (2 complete + 3 gap closure)
...
- [ ] 42-04-PLAN.md — 消息格式归一化 + 上下文恢复（G-42-3 AI 回复渲染原始 JSON + G-42-4 切换对话后上下文丢失：存储归一化 + 双形状读取 + switchConversation await 注入）
