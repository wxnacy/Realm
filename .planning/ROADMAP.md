...
- [x] 24-01-PLAN.md — CDP 底层：fillForm + executeAction 方法

**Wave 2** (depends on Wave 1)

- [x] 24-02-PLAN.md — AI 工具：fill_form + execute_action 注册 + 风险评估

**Wave 3** (depends on Wave 2)

- [x] 24-03-PLAN.md — 安全防护：CAPTCHA/2FA 检测 + 暂停恢复机制

**Wave 4** (depends on Wave 3)

- [x] 24-04-PLAN.md — UI：操作确认卡片 + IPC 通信 + CAPTCHA 等待指示器
...
- [x] 25-01-PLAN.md — 脚本生成后端：generate_script AI 工具 + 静态分析验证 (completed 2026-08-03)
- [x] 25-02-PLAN.md — 脚本预览卡片 UI：步骤列表、拖拽排序、内联编辑 (completed 2026-08-03)

**Wave 2** (depends on Wave 1)

- [x] 25-03-PLAN.md — 脚本执行引擎：逐步执行 + 实时状态反馈 + IPC 通信 (completed 2026-08-03)
