...
**Requirements**: TBD
**Depends on:** Phase 43
**Plans:** 18 plans（16 executed + 2 gap-closure planned, 44-UAT.md Round 3 gap G-44-7）
...
- [ ] 44-17-PLAN.md — G-44-7 泄漏层：convertToMp4 产物流同步 fd 创建消除 unlink 竞态 + 0 字节残留回归测试
- [ ] 44-18-PLAN.md — G-44-7 体验/分类层：清单解析加密检测（hasEncryption/keyUris）+ 缓存 key URI 排除 + 转换入口早拒与抽屉按钮隐藏
