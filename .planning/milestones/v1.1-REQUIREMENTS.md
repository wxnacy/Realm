...
- [x] **FREQ-01**: 新标签页展示常用网站网格
- [x] **FREQ-02**: 常用网站基于 frecency 算法（频率 + 最近性加权）排序
- [x] **FREQ-03**: 常用网站按域名聚合（同一域名下多个页面合并为一个卡片）
- [x] **FREQ-04**: 常用网站显示 favicon
- [x] **FREQ-05**: 常用网站合并所有容器历史记录（不按容器隔离，所有容器显示相同推荐）

### 设置页面

- [x] **SETT-01**: 用户可以打开设置页面
- [x] **SETT-02**: 设置页面包含默认浏览器引导功能
- [x] **SETT-03**: 默认浏览器使用当前容器打开外部链接
- [x] **SETT-04**: 设置持久化（electron-store）
- [x] **SETT-05**: 设置页面包含历史记录保留天数配置
